    ...
    <div className="border p-3 rounded-lg w-full bg-custom-gradient flex flex-col gap-y-2">
      <div className="flex gap-4 text-[#102837]">
        ...
        <p className="text-sm font-bold">
          {data.isPremium ? "Premium Plan" : "Free Trial"}
        </p>
      </div>
      ...
      <div className="flex text-white flex-col gap-y-2">
        ...
        <Progress
          value={
            data.isPremium ? 100 : (data.agentCount / MAX_AGENT_FREE) * 100
          }
        />
      </div>
      ...
      <div className="flex text-white flex-col gap-y-2">
        ...
        <Progress
          value={
            data.isPremium ? 100 : (data.meetingsCount / MAX_FREE_MEETING) * 100
          }
        />
      </div>
      ...
      {!data.isPremium && (
        <Button
          asChild
          className="h-10 font-bold text-white border-gray-700 hover:bg-[#102837]"
        >
